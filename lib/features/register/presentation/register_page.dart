...
class _RegisterPageState extends State<RegisterPage> {
  ...
  void login() async {
    ...
    final result = await studentRepository.register(
    ...
    result.when((success) {
      if (success) {
        ...
        showSnackBar(message: "Successfully Registered", color: Colors.green);
      } else {
        setState(() {
          isLoading = false;
        });
        showSnackBar(message: "Something Wrong", color: Colors.yellowAccent);
      }
    }, (error) {
      setState(() {
        isLoading = false;
